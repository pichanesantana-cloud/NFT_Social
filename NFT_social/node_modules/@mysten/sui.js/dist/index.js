...
function isTransactionEffects(obj, _argumentName) {
  return (obj !== null && typeof obj === "object" || typeof obj === "function") && isExecutionStatus(obj.status) && isGasCostSummary(obj.gasUsed) && (typeof obj.sharedObjects === "undefined" || Array.isArray(obj.sharedObjects) && obj.sharedObjects.every(
    ...
    (e) => isSuiObjectRef(e)
  )) && isOwnedObjectRef(obj.gasObject) && (typeof obj.events === "undefined" || Array.isArray(obj.events) && obj.events.every(
    (e) => isSuiEvent(e)
  )) && (typeof obj.dependencies === "undefined" || Array.isArray(obj.dependencies) && obj.dependencies.every(
    (e) => isTransactionDigest(e)
  ));
}
...
function isCoinMetadata(obj, _argumentName) {
  return (obj !== null && typeof obj === "object" || typeof obj === "function") && isSuiMoveTypeParameterIndex(obj.decimals) && isTransactionDigest(obj.name) && isTransactionDigest(obj.symbol) && isTransactionDigest(obj.description) && (obj.iconUrl === null || isTransactionDigest(obj.iconUrl)) && (obj.id === null || isTransactionDigest(obj.id));
}
...
var JsonRpcProvider = class extends Provider {
  ...
  async executeTransaction(txnBytes, signatureScheme, signature, pubkey, requestType = "WaitForEffectsCert") {
    try {
      ...
      if ((version == null ? void 0 : version.major) === 0 && (version == null ? void 0 : version.minor) < 18) {
...
var SignerWithProvider = class {
  ...
  async signAndExecuteTransaction(transaction, requestType = "WaitForLocalExecution") {
    if (transaction instanceof Base64DataBuffer || transaction.kind === "bytes") {
      ...
      let dataToSign;
      let txBytesToSubmit;
      if ((version == null ? void 0 : version.major) == 0 && (version == null ? void 0 : version.minor) < 19) {
        dataToSign = txBytes;
  ...
  async getTransactionDigest(tx) {
    ...
    return generateTransactionDigest(
      ...
      sig.signature,
      sig.pubKey,
      (version == null ? void 0 : version.major) == 0 && (version == null ? void 0 : version.minor) < 18 ? "base64" : "base58",
      (version == null ? void 0 : version.major) == 0 && (version == null ? void 0 : version.minor) < 18 ? false : true
    );
  }
